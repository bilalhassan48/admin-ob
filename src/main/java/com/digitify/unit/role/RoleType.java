...
public enum RoleType implements Matchable {
    ...
    public static RoleType getType(String code, ErrorCode errorCode, String errorMessage) {
    ...
    public static List<RoleType> getAllTypes() {
