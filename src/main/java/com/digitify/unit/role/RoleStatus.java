...
public enum RoleStatus implements Matchable {
    ...
    public static RoleStatus getType(String code) {
        return stream(values()).filter(type -> type.getCode().equalsIgnoreCase(code)).findFirst().orElse(null);
    }

    public static RoleStatus getType(String code, ErrorCode errorCode, String errorMessage) {
    ...
    public static List<RoleStatus> getAllTypes() {
