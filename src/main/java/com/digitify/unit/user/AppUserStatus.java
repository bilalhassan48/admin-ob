...
public enum AppUserStatus implements Matchable {
    ...
    AppUserStatus(String code, String value) {
        this.code = code;
        this.value = value;
    }
    ...
    public static AppUserStatus getType(String code) {
        return stream(values()).filter(type -> type.getCode().equalsIgnoreCase(code)).findFirst().orElse(null);
    }

    public static AppUserStatus getType(String code, ErrorCode errorCode, String errorMessage) {
    ...
    public static List<AppUserStatus> getAllTypes() {
